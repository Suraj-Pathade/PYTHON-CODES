...
hour =Spinbox(ftwo,from_=0,to=59,wrap=True,textvariable=hour_string,font=f,width=2,justify=CENTER)
...
msg = Label(root, text="Hour Minute Seconds",font=("Times New Roman", 12))
msg.pack(side=TOP)
actionBtn =Button(root,text="SELECT",padx=10,pady=10,command=display_msg)
